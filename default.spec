...
title = VIIDU - Информационно-диагностическая утилита

# (str) Package name
package.name = viidu

# (str) Package domain (needed for android/ios packaging)
package.domain = org.viidu

# (str) Source code where the main.py live
source.dir = .

# (str) Main python file
main.py = VIIDU_Kivy_apk.py
...
requirements = python3,kivy,psutil,cpuinfo
...
android.permissions = android.permission.INTERNET,android.permission.ACCESS_NETWORK_STATE,android.permission.READ_PHONE_STATE,android.permission.GET_TASKS
